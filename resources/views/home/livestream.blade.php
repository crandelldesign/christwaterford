...
<div class="row">
    <div class="col-md-8">
        ...
        <h2>Lutheran Worship 5-28-17</h2>
        <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" id="ls_embed_1495715583" src="https://livestream.com/accounts/8727672/events/7434368/player?width=640&height=360&enableInfoAndActivity=true&defaultDrawer=&autoPlay=true&mute=false" width="640" height="360" frameborder="0" scrolling="no" allowfullscreen> </iframe>
        </div>

        <h2>Lutheran Worship 5-21-17</h2>
        <div class="embed-responsive embed-responsive-16by9">
