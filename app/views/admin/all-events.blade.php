      ...
      <div class="modal-body">
        <form action="#" method="post" role="form" class="form-horizontal">
		  	...
		  	<div class="form-group">
		    	...
		    	<div class="input-group date col-sm-7" id="event_date_group">
			...
			<div class="form-group start-time-group">
		        ...
		        <div class="input-group date col-sm-7" id="start_time_group">
		    ...
		    <div class="form-group end-time-group">
		        ...
		        <div class="input-group date col-sm-7" id="end_time_group">
...
EventsControl = can.Control(
{
    ...
    '#editEventModal hidden.bs.modal': function()
    {
      $('#summernote').destroy();
    },
    //Methods
