...
<div class="row">
    <div class="col-md-8">
        ...
        <h2>Lutheran Worship 9-11-16</h2>
        <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" id="ls_embed_1473103184" src="//livestream.com/accounts/8727672/events/6297179/player?width=560&height=315&autoPlay=true&mute=false" width="560" height="315" frameborder="0" scrolling="no" allowfullscreen></iframe>
        </div>

        <h2>Lutheran Worship 8-26-16</h2>
        <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" id="ls_embed_1471963370" src="//livestream.com/accounts/8727672/events/6213277/player?width=560&height=315&autoPlay=true&mute=false" width="560" height="315" frameborder="0" scrolling="no" allowfullscreen></iframe>
        </div>
        </div>
