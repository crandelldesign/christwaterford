...
class AdminController extends BaseController {
	...
	public function getIndex()
	{
		if(!Auth::check()) {
	        ...
	        $vw->title = "Christ Lutheran Church of Waterford - Admin Access";
	        $vw->description = "";
	...
	public function postAddEvent()
	{
		...
		//echo Input::get('is_all_day').' '.Input::get('is_featured');
		//exit;
		...
		$events->is_featured = (Input::get('is_featured'))?1:0;
		$events->is_all_day = (Input::get('is_all_day'))?1:0;
