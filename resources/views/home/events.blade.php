...
<div class="row">
    ...
    <div class="col-xs-6 col-sm-4 col-sm-pull-4"><a href="{{url('/')}}/events/{{strtolower(getdate($prev_month)['month'])}}-{{date('Y',$prev_month)}}" class="last-month">Last Month</a></div>
    <div class="col-xs-6 col-sm-4 text-right"><a href="{{url('/')}}/events/{{strtolower(getdate($next_month)['month'])}}-{{date('Y',$next_month)}}" class="next-month">Next Month</a></div>
</div>
